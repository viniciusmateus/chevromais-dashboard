...
export default function Button({ label, name, onClick, type = "button",disabled , className = "", ...props }) {
  const baseClasses =
    "w-full border border-zinc-900 bg-zinc-950 p-3 text-xs text-white font-medium rounded-lg cursor-pointer uppercase col-span-2 hover:bg-slate-700 transition-all duration-200";
  const linkClasses =

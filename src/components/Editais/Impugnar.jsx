...
export default function Impugnar() {
    ...
    const [selectedObjections, setSelectedObjections] = useState({
        delivery: false, sample: false, ence: false, service: false,
        manufacturing: false, abrafati: false, abipti: false, restriction: false,
    });
    ...
    const getInputClassName = (isInvalid) => 
        `p-2.5 border rounded-lg text-sm focus:outline-none focus:ring-1 font-medium w-full transition-all ${
            isInvalid 
            ? "bg-red-500/5 border-red-500 text-zinc-200 focus:border-red-500 focus:ring-red-500 placeholder-red-400/50" 
            : "bg-zinc-900 border-zinc-800 text-zinc-200 focus:border-lime-400 focus:ring-lime-400 placeholder-zinc-600"
        }`;
                ...
                <div className="border-t border-zinc-800/80 pt-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            {dateErrorMessage && (
                                <span className="text-red-500 text-[11px] font-bold mt-1.5 block">{dateErrorMessage}</span>
                            )}
                        </div>
                        <div>
                    ...
                    {(buyer === "COM LOCALIDADE" || buyer === "SEM LOCALIDADE") && (
                        <div className="mt-4">
                            <label className={labelStyle}>
                                {buyer === "COM LOCALIDADE" ? "Nome do Órgão (Com Localidade)" : "Nome do Órgão (Sem Localidade)"}
                            </label>

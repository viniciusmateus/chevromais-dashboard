  ...
  <div className="flex flex-col items-center gap-6">
    <div className="relative w-20 h-20">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-8 h-8 animate-pulse rounded-lg" style={{ backgroundColor: ACCENT }} />
      </div>
    </div>
      ...
      <div className="relative w-full bg-zinc-950/95 backdrop-blur-xl border-2 border-[#afd136] p-10 overflow-hidden">
        <div className="relative z-10 w-full">
          <div className="flex items-center justify-evenly mb-6 gap-5">
            ...
            <h1 className="text-3xl font-black text-white tracking-tighter mb-2 uppercase transform -skew-x-3">
              PneusCuritiba Dashboard
            </h1>
          </div>
          <p className="text-zinc-400 text-center leading-relaxed tracking-widest transform -skew-x-2">
        ...
        >
          ...
          <div className="relative z-10 shrink-0 transform skew-x-[4deg]">
            <svg className="w-5 h-5 shrink-0 relative" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="relative z-10">
          <div className={`flex items-center gap-3 mb-6 p-4 transform skew-x-[-8deg] ${accentBg}/10 border ${accentBorder}/40`}>
            ...
            <div className="transform skew-x-[8deg]">
              <h2 className="text-xl font-black text-white tracking-tighter uppercase transform -skew-x-3">
                {isRejected ? "Acesso Recusado" : "Aprovação Pendente"}
              </h2>
              <p className={`text-sm font-medium ${isRejected ? "text-red-400" : `text-[${ACCENT}]`} transform -skew-x-2`}>
                Status: {status}
              </p>
            </div>
          </div>

          <p className="text-zinc-400 text-sm mb-8 leading-relaxed tracking-wide transform -skew-x-2">
            {isRejected
